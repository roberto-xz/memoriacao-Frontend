import{r as n}from"./repository-a4ORCXID.js";const o=async(e,i,l)=>{let a=`SELECT COUNT(*) as t FROM publications WHERE type = '${l}'`;return e!=="all"&&(a+=` AND category = '${e}'`),i!==0&&(a+=` AND publication_year = ${i}`),(await n.query(a))[0]?.t||0},b=async(e,i=2)=>{let l=`
